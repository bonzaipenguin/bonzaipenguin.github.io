    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        <Grid container spacing={3}>
          <Grid size={12}>
            <Image src="/imgs/kqed/landing-page.png" alt="view of the live streaming player" width={1200} height={900} style={{objectFit: "cover"}}></Image>
          </Grid>
          ...
          <Grid size={12}>
            <Image src="/imgs/kqed/screens.png" alt="variety of app views" width={1200} height={900} style={{objectFit: "cover"}}></Image>
          </Grid>
          <Grid size={{ xs: 12, md: 10 }} offset={{ md: 1 }}>
            <p>
          ...
          <Grid size={12}>
            <Image src="/imgs/kqed/screen-flow.png" alt="App screen flow" width={1300} height={800} style={{objectFit: "cover"}}></Image>
          </Grid>
        </Grid>
      </main>

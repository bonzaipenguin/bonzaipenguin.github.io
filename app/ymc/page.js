    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        <Grid container spacing={3}>
          <Grid size={12}>
              <Image src="/imgs/ymc/Challenge.jpg" alt="Example of a challenge" width={800} height={600} style={{objectFit: "cover"}}></Image>
          </Grid>
          ...
          <Grid size={12}>
            <Image src="/imgs/ymc/Submission.jpg" alt="Submission flow" width={800} height={600} style={{objectFit: "cover"}}></Image>
          </Grid>
          <Grid size={{ xs: 12, md: 10 }} offset={{ md: 1 }}>
            <p>
          ...
          <Grid size={12}>
            <Image src="/imgs/ymc/AdvancedFilters.jpg" alt="Example of the advanced filters" width={800} height={600} style={{objectFit: "cover"}}></Image>
          </Grid>
        </Grid>
      </main>

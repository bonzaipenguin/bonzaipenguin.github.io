    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        <Grid container spacing={3}>
          <Grid size={12}>
              <Image src="/imgs/ymc/Challenge.png" alt="Example of a challenge" width={500} height={500} style={{objectFit: "cover"}}></Image>
          </Grid>
          ...
          <Grid size={12}>
            <Image src="/imgs/ymc/Submission.png" alt="Submission flow" width={500} height={500} style={{objectFit: "cover"}}></Image>
          </Grid>
          <Grid size={{ xs: 12, md: 10 }} offset={{ md: 1 }}>
            <p>
          ...
          <Grid size={12}>
            <Image src="/imgs/ymc/AdvancedFilters.png" alt="Example of the advanced filters" width={500} height={500} style={{objectFit: "cover"}}></Image>
          </Grid>
        </Grid>
      </main>

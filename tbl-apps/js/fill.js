define(['jquery','model'], function($,model) {
	...
	var fill = {
		...
		basicInfo:function(){
			...
			var a6 = $('<div class="form-group col-sm-12 required"><label for="entry.1062374156" class="required">Personal Email Address</label><input class="form-control" type="text" name="entry.1062374156"></div>');

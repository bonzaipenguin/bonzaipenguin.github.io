define(['jquery'], function($) {
	...
	var candidate = {
		...
		boardInfo:function(){
			...
			var a2 = $('<div class="form-check col-sm-12"><label class="form-check-label" for=""><input class="form-check-input" type="checkbox" name="" value="Advisory">Advisory board</label></div>');
